...
class CustomField extends Component {
    ...
    render() {
        ...
        return (
            <View onLayout={onLayout} style={[{ flex: 1, marginBottom:22 }, containerStyle]}>
                <View style={itemStyle} underline error={hasError && touched}>
                    ...
                    <TextInput {...input}
                        ...
                        placeholderTextColor={placeholderTextColor ? placeholderTextColor : AppStyles.COLOR_BLACK}
